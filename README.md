...
- **Phase 4 (en cours)** : Pilote Bistrot de Nérigean — mini RAG déployé (knowledge.txt L'Invariable), system prompt 3 niveaux, protocole Windows→Linux établi. Avant déploiement : test mini RAG, feature eau économisée, retrait accès root SSH
