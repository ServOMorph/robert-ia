...
* **Phase 4 [EN COURS]** : Pré-déploiement. Mini-RAG avec `knowledge.txt` (L'Invariable) testé et validé, bandeau eau économisée implémenté (total cumulé depuis la mise en service, comparaison impact écologique local vs cloud), suppression à venir de l'accès root SSH.
